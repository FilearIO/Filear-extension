...
const Arweave: React.FC<IconProps> = ({ size = 60 }) => {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x={size} y={size} viewBox="0 0 31.8 31.8">
      <circle stroke="#222326" strokeWidth="2.5" cx="15.9" cy="15.9" r="14.7" fill="none" />
      <path
...
export default React.memo(Arweave)
